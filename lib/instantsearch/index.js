    ...
    serverPrefetch() {
      ...
      return new Promise((resolve, reject) =>
        ...
        .then(() => {
          ...
          // console.log('serverPrefetch', search);
          ...
          console.log(
            'serverPrefetch - main widgets',
            search.mainIndex.getWidgets()
          );

          console.log(
            'serverPrefetch - widgetState TODO',
            search.mainIndex.getWidgetState(initialUiState)
          );

          console.log(
            'serverPrefetch - searchParameters TODO use',
            search.mainIndex.getWidgetSearchParameters(helper.state, {
              uiState: {
                configure: {
                  hitsPerPage: 100,
                },
